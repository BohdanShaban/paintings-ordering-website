...
/* harmony import */ var _modules_modalWind__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/modalWind */ "./src/js/modules/modalWind.js");
/* harmony import */ var _modules_sliders__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/sliders */ "./src/js/modules/sliders.js");
/* harmony import */ var _modules_formsPostOnServ__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/formsPostOnServ */ "./src/js/modules/formsPostOnServ.js");
...
/* harmony import */ var _modules_showMoreCards__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/showMoreCards */ "./src/js/modules/showMoreCards.js");
/* harmony import */ var _modules_showCardsFromServ__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/showCardsFromServ */ "./src/js/modules/showCardsFromServ.js");
...
/* harmony import */ var _modules_filtrationOfWorks__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/filtrationOfWorks */ "./src/js/modules/filtrationOfWorks.js");
/* harmony import */ var _modules_hoverPictsChangeing__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/hoverPictsChangeing */ "./src/js/modules/hoverPictsChangeing.js");
/* harmony import */ var _modules_accordionForQuests__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/accordionForQuests */ "./src/js/modules/accordionForQuests.js");
...
/* harmony import */ var _modules_scrollingSlow__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/scrollingSlow */ "./src/js/modules/scrollingSlow.js");
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modalWind__WEBPACK_IMPORTED_MODULE_0__["default"])();
  ...
  Object(_modules_formsPostOnServ__WEBPACK_IMPORTED_MODULE_2__["default"])();
  Object(_modules_phoneMask__WEBPACK_IMPORTED_MODULE_3__["default"])('[name="phone"]');
  Object(_modules_showMoreCards__WEBPACK_IMPORTED_MODULE_4__["default"])('.button-styles', '.styles-2'); //showCardsFromServ('.button-styles' , 'http://localhost:3000/styles', '[data-cards]'); // <!-- COMMENT THIS SECTION -->

  Object(_modules_calculator__WEBPACK_IMPORTED_MODULE_6__["default"])('#size', '#material', '#options', '.promocode', '.calc-price');
  Object(_modules_filtrationOfWorks__WEBPACK_IMPORTED_MODULE_7__["default"])();
  Object(_modules_hoverPictsChangeing__WEBPACK_IMPORTED_MODULE_8__["default"])('.sizes-block');
  Object(_modules_accordionForQuests__WEBPACK_IMPORTED_MODULE_9__["default"])('.accordion-block', '.accordion-heading');
  Object(_modules_burgerMenu__WEBPACK_IMPORTED_MODULE_10__["default"])('.burger', '.burger-menu');
  Object(_modules_scrollingSlow__WEBPACK_IMPORTED_MODULE_11__["default"])('.pageup');
}); // document.addEventListener( 'DOMContentLoaded' END

/***/ }),

/***/ "./src/js/modules/accordionForQuests.js":
/*!**********************************************!*\
  !*** ./src/js/modules/accordionForQuests.js ***!
  \**********************************************/
...
var accordionForQuests = function accordionForQuests(blocksSel, headingsSel) {
  ...
  var showBlock = function showBlock(idx) {
    if (idx || idx === 0) {
      // !!! 0 -> false
      // Hide All Blocks
  ...
  showBlock();
  btns.forEach(function (heading, idx) {
    heading.addEventListener('click', function () {
      btns.forEach(function (heading) {
        return heading.classList.remove('active-style');
      }); // !!! in main.css
...
/* harmony default export */ __webpack_exports__["default"] = (accordionForQuests);

/***/ }),

/***/ "./src/js/modules/additional/checkTxtInputs.js":
/*!*****************************************************!*\
  !*** ./src/js/modules/additional/checkTxtInputs.js ***!
  \*****************************************************/
/*! exports provided: default */
...
var checkTxtInputs = function checkTxtInputs(selector) {
...
/* harmony default export */ __webpack_exports__["default"] = (checkTxtInputs);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var burgerMenu = function burgerMenu(burgBtnSel, menuSel) {
  console.log("burgerMenu.js Connected...");
  var burgerBtn = document.querySelector(burgBtnSel),
      burgMenu = document.querySelector(menuSel); //

  burgMenu.style.display = 'none';
  burgerBtn.addEventListener('click', function () {
    if (burgMenu.style.display == 'none' && window.screen.availWidth < 993) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var calculator = function calculator(sizeSel, materialSel, addOptionsSel, promoSelect, resultSel) {
  console.log("calculator.js Connected...");
  var sizeEl = document.querySelector(sizeSel),
  ...
  var makeCalculus = function makeCalculus() {
    var sum = Math.round(+sizeEl.value * +materialEl.value + +addOptsEl.value);
...
/***/ "./src/js/modules/filtrationOfWorks.js":
/*!*********************************************!*\
  !*** ./src/js/modules/filtrationOfWorks.js ***!
  \*********************************************/
/*! exports provided: default */
...
var filtrationOfWorks = function filtrationOfWorks() {
  // Imperative Style (with no Args)
  console.log("filtrationOfWorks.js Connected..."); // MENU VARS :
  ...
  var filterElms = function filterElms(elmsArr) {
    // Hide All
    ...
    notExistCurrently.classList.remove('animated', 'fadeInUp'); // Show Certain
  ...
  grandyBtn.addEventListener('click', function () {
    filterElms();
  });
  grandFathBtn.addEventListener('click', function () {
    filterElms();
  ...
  menu.addEventListener('click', function (e) {
    ...
    if (target && target.tagName === 'LI') {
      allBtnsArr.forEach(function (menuItem) {
...
/* harmony default export */ __webpack_exports__["default"] = (filtrationOfWorks);
...
/* harmony import */ var _modules_additional_checkTxtInputs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../modules/additional/checkTxtInputs */ "./src/js/modules/additional/checkTxtInputs.js");
...
var formsPostOnServ = function formsPostOnServ() {
  console.log("formsPostOnServ.js Connected...");
  var formsArr = document.querySelectorAll('form'),
      inputsArr = document.querySelectorAll('input'),
      // Only For:  Clear Form Inputs
  ...
  var clearAllInputs = function clearAllInputs() {
    ...
    upldPhotoInputs.forEach(function (inputTag) {
  ...
  upldPhotoInputs.forEach(function (inputTag) {
    inputTag.addEventListener('input', function () {
      var fileNameSplitedArr = inputTag.files[0].name.split('.');
      var dots;
      fileNameSplitedArr[0].length > 6 ? dots = '...' : dots = '.';
      var flileName = fileNameSplitedArr[0].substring(0, 6) + dots + fileNameSplitedArr[1];
  ...
  formsArr.forEach(function (form) {
    form.addEventListener('submit', function (e) {
      ...
      var formData = new FormData(form); // SELECT END SERVER URL

      var apiPath;
      form.closest('.popup-design') || form.classList.contains('calc_form') ? apiPath = serverPathes.designer : apiPath = serverPathes.question; // POST Data (FormData Obj) On Server

      Object(_services_requests__WEBPACK_IMPORTED_MODULE_7__["postData"])(apiPath, formData).then(function (res) {
        console.log(res);
        textMessage.textContent = messages.success;
        createdImg.setAttribute('src', messages.okImg);
      }).catch(function () {
        textMessage.textContent = messages.error;
        createdImg.setAttribute('src', messages.failImg);
      }).finally(function () {
        clearAllInputs();
        setTimeout(function () {
          messageDiv.remove();
...
/***/ "./src/js/modules/hoverPictsChangeing.js":
/*!***********************************************!*\
  !*** ./src/js/modules/hoverPictsChangeing.js ***!
  \***********************************************/
/*! exports provided: default */
...
var hoverPictsChangeing = function hoverPictsChangeing(picsSel) {
  console.log("hoverPictsChangeing.js Connected...");
  var picsDivs = document.querySelectorAll(picsSel);

  var showPicture = function showPicture(divBlock) {
    var imgTag = divBlock.querySelector('img'); // assets/img/sizes-1.png  =>  assets/img/sizes-1-1.png

    imgTag.src = imgTag.src.slice(0, -4) + '-1.png';
    var allParagrapTags = divBlock.querySelectorAll('p:not(.sizes-hit)'); // !!!

    allParagrapTags.forEach(function (p) {
      p.style.display = 'none';
    });
  };

  var hidePicture = function hidePicture(divBlock) {
    var imgTag = divBlock.querySelector('img'); // assets/img/sizes-1-1.png  =>  assets/img/sizes-1.png
  ...
  picsDivs.forEach(function (picture) {
...
/* harmony default export */ __webpack_exports__["default"] = (hoverPictsChangeing);
...
var modalWind = function modalWind() {
  console.log("modalWind.js Connected..."); // OPEN / CLOSE  Modal Wind
  ...
  var showModalByTime = function showModalByTime(modalSelector, time) {
    setTimeout(function () {
      // !!! Set TimeOut First
      var display; // IF SOME MODAL IS CURRENTLY OPEN
  ...
  var showGiftModal = function showGiftModal(selector) {
  ...
  function bindModalWind(trigersSelector, modalSelector, closeSelector) {
    var destrClckedEl = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
    var openTrigs = document.querySelectorAll(trigersSelector),
    ...
    openTrigs.forEach(function (triger) {
      triger.addEventListener('click', function (e) {
        ...
        btnPressed = true; // CLOSE ALL MODAL WINDS
        //allModal.forEach( window => { window.style.display = 'none'; })

        allModal.forEach(function (window) {
          closeModalWind(window);
        });
        openModalWind(modal);
      });
    });
    closeTriger.addEventListener('click', function (e) {
      // ???
      if (e.target) {
        e.preventDefault();
      } // ???  e.preventDefault()
    ...
    modal.addEventListener('click', function (e) {
      if (e.target === modal) {
        closeModalWind(modal); // CLOSE ALL MODAL WINDS
        //allModal.forEach( window => { window.style.display = 'none'; }) 
  ...
  bindModalWind('.button-consultation', '.popup-consultation', '.popup-consultation .popup-close'); //showModalByTime('.popup-consultation', 60000);
  // PRESENT

  bindModalWind('.fixed-gift', '.popup-gift', '.popup-gift .popup-close', true); // SHOW GIFT POPUP MODAL IF ANY BUTTON WAS NOT PRESSED
...
var phoneMask = function phoneMask(selector) {
  console.log("phoneMask.js Connected...");
...
/***/ "./src/js/modules/scrollingSlow.js":
/*!*****************************************!*\
  !*** ./src/js/modules/scrollingSlow.js ***!
  \*****************************************/
/*! exports provided: default */
...
var scrollingSlow = function scrollingSlow(upArrowSel) {
  console.log("scrollingSlow.js Connected...");
  var upArrow = document.querySelector(upArrowSel);
  window.addEventListener('scroll', function () {
...
/* harmony default export */ __webpack_exports__["default"] = (scrollingSlow);
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          throw new Error("Couldnt fetch Url: ".concat(result.url, " With Err Status: ").concat(result.status));
...
/***/ "./src/js/modules/showCardsFromServ.js":
/*!*********************************************!*\
  !*** ./src/js/modules/showCardsFromServ.js ***!
  \*********************************************/
/*! exports provided: default */
...
var showCardsFromServ = function showCardsFromServ(trigBtnSelector, url, parentSelector) {
  console.log("showCardsFromServ.js Connected...");
  var trigBtn = document.querySelector(trigBtnSelector);
  trigBtn.addEventListener('click', function () {
    Object(_services_requests__WEBPACK_IMPORTED_MODULE_3__["getResource"])(url).then(function (ArrOfObjcts) {
      ArrOfObjcts.forEach(function (obj) {
        var src = obj.src,
            title = obj.title,
            link = obj.link;
  ...
  var makeCards = function makeCards(src, title, link) {
...
/* harmony default export */ __webpack_exports__["default"] = (showCardsFromServ);
...
var showMoreCards = function showMoreCards(btnSelector, cardsSelector) {
  console.log("showMoreCards.js Connected...");
  var cardsArr = document.querySelectorAll(cardsSelector),
...
////////    SLIDERS  (L 4)     ///////////
var sliders = function sliders(slidesSel, direction, nextBtnSel, prevBtnSel) {
  // 
  console.log("sliders.js Connected...");
  var slidesArr = document.querySelectorAll(slidesSel);
  var slideIdx = 1; // !!!  ->  slidesArr[slideIdx-1] ALWAYS WHEN WORK WITH ARR !!!

  var paused = false; // !!! let only & false ?

  var showSlide = function showSlide(idx) {
    // BOUNDARIES
    if (idx > slidesArr.length) {
      slideIdx = 1;
    }

    if (idx < 1) {
      slideIdx = slidesArr.length;
    }
  ...
  showSlide(slideIdx); // SOME SLIDER DON'T HAVE BTNS 
  ...
  var activateAnimation = function activateAnimation(time) {
  ...
  activateAnimation(3000); // STOP SLIDES SWITCHING IF(mouseenter) & LAUNCH SWITCHING IF(mouseleave)

  slidesArr[0].parentNode.addEventListener('mouseenter', function () {
    // !!! slidesArr[0].parentNode.
    clearInterval(paused);
  });
  slidesArr[0].parentNode.addEventListener('mouseleave', function () {
